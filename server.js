...
app.get('/api/blood/request/list',authenticateUser,authorizeUser(['bloodbank']),bloodRequestCltr.listToBloodBank)
...
app.get('/api/blood/request/user',authenticateUser,authorizeUser(['user']),bloodRequestCltr.list) //to see request made by him(his request)
...
app.put('/api/response/:id',authenticateUser,authorizeUser(['user','bloodbank']),responseCtrl.userResponse)
